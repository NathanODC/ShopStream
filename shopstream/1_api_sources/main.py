...
from .utils import setup_log_execution, get_or_create_pubsub_topic, read_local_file, convert_json_array_to_ndjson
...
def hello_http(request):
    ...
    try:
        ...
        data_topic_map = [
            {"data": clickstream_data, "topic": pubsub_topics.get("clickstream"), "extension": "json"},
            {"data": customer_support_data, "topic": pubsub_topics.get("customer_support"), "extension": "json"},
            {"data": product_catalog_data, "topic": pubsub_topics.get("product_catalog"), "extension": "json"},
            {"data": sales_transactions_data, "topic": pubsub_topics.get("sales_transactions"), "extension": "csv"},
        ]
